...
input_dir = os.path.join('data', 'raw', 'qd-scan-automation-sample-1', 'power dependence of positively charged QD')
output_dir = os.path.join('outputs', 'qd-scan-automation-sample-1', 'power dependence of positively charged QD')
...
for txt_file in txt_files:
    ...
    if len(intensity) == 0:
      ...
      intensity = np.column_stack((intensity, data[:, 1]))
